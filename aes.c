...
void Cipher(unsigned char state[][4],unsigned char in[],unsigned char RoundKey[],unsigned char out[])
{
    int i,j,round=0;
...
void InvCipher(unsigned char state[][4],unsigned char in[],unsigned char RoundKey[],unsigned char out[])
{
    int i,j,round=0;
...
{
    unsigned char RoundKey[240],state[4][4];
    KeyExpansion(RoundKey,key);
    Cipher(state,input,RoundKey,out);
}
...
void aesdecrypt(unsigned char key[],unsigned char cipher[],unsigned char out[])
{
    unsigned char RoundKey[240],state[4][4];
    KeyExpansion(RoundKey,key);
    InvCipher(state,cipher,RoundKey,out);
}
